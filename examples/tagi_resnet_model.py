...
def resnet18_cifar100(
    ...
    """Resnet18 architecture for cifar100 (100 classes)"""
    # 32x32
    initial_layers = [
        Conv2d(
            3,
    ...
    if is_remax:
        final_layers = [
            AvgPool2d(4),
            Linear(512, 100, gain_weight=gain_w, gain_bias=gain_b),
            Remax(),
        ]
    else:
        final_layers = [
            AvgPool2d(4),
            # 200 = 100 * 2 for dual-stream (epistemic + aleatoric)
            Linear(512, 200, gain_weight=gain_w, gain_bias=gain_b),
            EvenExp(),
        ]
